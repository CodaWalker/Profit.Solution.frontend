      ...
      <div class="col-md-4 order-md-2 mb-4">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
              <small class="text-muted"><div class="mt-3"></div>
                <div class="input-group mb-3 mt-3">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelectTypeUser">Тип записи</label>
                  </div>
                  <select class="custom-select" id="inputGroupSelectTypeUser" v-model="user.typeUser"  name="TypeUser">
          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed" v-if="user.typeUser === '2'">
            <div>
              <small class="text-muted"><div class="mt-4"></div>
                <div class="input-group mb-3 mt-3">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelectSpecialization">Специализация</label>
                  </div>
                  <select class="custom-select" id="inputGroupSelectSpecialization" v-model="user.specialization"  name="Specialization">
          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
              <small class="text-muted">  <div class="form-group">
                ...
                <div class="form-group"></div></small>
            </div>
          </li>
        </ul>
      </div>
