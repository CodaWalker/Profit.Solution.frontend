<template>
    ...
    <div class="row">
      ...
      <div class="col-md-8 order-md-1">
        ...
        <div class=" form-group mb-3">
          ...
          >Название заявки обязательно.</div>
          ...
          <div class=" form-group mb-3">
            ...
            <b-row>
              <b-col>            <b-button :disabled="lockButtonSender" @click="showModalChangeSender" ref="showModalChangeSender">Выбрать клиента</b-button>
              </b-col>
              <b-col> <div v-if="ticket.sender_username">
            ...
            <b-modal id="modal-xl-1" size="xl" title="Выбор клиента">      <div class="container">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <template v-slot:cell(выбрать)="row">
                        <b-button size="sm" @click="changeUserClicked(row.item.id,row.item.username)" class="mr-2">
                          открыть
                        </b-button>
                      </template>
          ...
          <b-row>
            <b-col>            <b-button  :disabled="lockButtonRecipient" @click="showModalChangeRecipient" ref="showModalChangeRecipient">Выбрать исполнителя</b-button>
            </b-col>
            <b-col> <div v-if="ticket.recipient_username">
            ...
            <div v-else>
              ...
              <b-modal id="modal-xl" size="xl" title="Выбор исполнителя">      <div class="container">
 ...
 <!--------------------------------------------UserList--END---------------------------------------------------------------------------->
          ...
          <b-row>
            <b-col>            <b-button :disabled="lockButtonOperator" @click="showModalChangeOperator" ref="showModalChangeOperator">Выбор оператора</b-button>
            </b-col>
            <b-col> <div v-if="ticket.operator_username">
          ...
          <b-modal id="modal-xl-2" size="xl" title="Выбор оператора" >      <div class="container">
        ...
        <div class=" form-group mb-3">
          ...
          <textarea :disabled="lockFieldTicketTitleAndDesc" v-model="ticket.description" class="form-control" aria-label="With textarea" id="description" placeholder="......" required=""></textarea>
