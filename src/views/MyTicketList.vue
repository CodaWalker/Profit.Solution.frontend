                ...
                <template v-slot:row-details="row">
                    <div class="form-group">
                        <b-form-row>
                            ...
                            <textarea disabled v-text="row.item.description" class="form-control"
...
<script>
    ...
    export default {
        ...
        computed: {
            pages() {
                return Math.ceil(this.totalTicketsDB / this.ticketsForPage);
            }
        },
        methods: {
            getMyTickets() {
                ...
                TicketService.getMyTickets(options, true).then(res => {
                    // eslint-disable-next-line no-console
                    console.log(res);
                })
            },
            ...
            getLengthTicketList() {
                ...
                TicketService.getMyTickets(options, false).then(res => {
                    this.totalTicketsDB = res.data.length;
                }, console.log);
            },
