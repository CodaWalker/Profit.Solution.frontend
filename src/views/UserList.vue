...
<!--                <th scope="col">Заявки<br>Закрытые</th>-->
<!--                <th scope="col">Заявки<br>Открытые</th>-->
...
<!--                <td>0</td>-->
<!--                <td>1</td>-->
<!--                <td><button class="btn btn-success" v-on:click="updateUserClicked(user.id)">Update</button></td>-->
<!--                <td><button class="btn btn-warning" v-on:click="deleteUser(user.id)">Delete</button></td>-->
<!--                <td><button class="btn btn-warning" v-on:click="openUserClicked(user.id,'open')">Open</button></td>-->
<!--              </tr>-->
<!--            </tbody>-->
<!--          </table>-->
<!--      <div class="row">-->
<!--        <button class="btn btn-success" v-on:click="addUserClicked()">Add</button>-->
<!--      </div>-->
<!--    </div>-->
...
export default {
  ...
  computed:{
    pages(){return  Math.ceil(this.totalUsersDB/this.usersForPage);}
  },
  methods: {
