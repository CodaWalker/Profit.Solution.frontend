      ...
      <div class="navbar-nav mr-auto">
        ...
        <li class="nav-item"  v-if="currentUser !== null && user.typeUser === 'operator'">
          <a href="/users" class="nav-link">
            <font-awesome-icon icon="user"/>Список пользователей(О)
          </a>
        </li>
          <li class="nav-item"  v-if="currentUser !== null && user.typeUser === 'operator'">
        ...
        <li class="nav-item"  v-if="currentUser !== null && user.typeUser === 'client'">
          <a @click="addTicketPage()" href="" class="nav-link">
            <font-awesome-icon icon="user"/> Создать заявку(К)
          </a>
        </li>
        <li class="nav-item"  v-if="currentUser !== null && user.typeUser === 'operator'">
          <a @click="addTicketPage()" href="" class="nav-link">
            <font-awesome-icon icon="user"/> Создать заявку(О)
          </a>
        </li>
      </div>
      ...
      <div class="navbar-nav ml-auto" v-if="!currentUser">
        <li class="nav-item">
          <a href="/register" class="nav-link">
            <font-awesome-icon icon="user"/> Регистрация
          </a>
        </li>
        <li class="nav-item">
